...
/// Formation breathing animation parameters
const BREATHE_SPEED: f32 = 0.8; // Cycles per second (slower)
const BREATHE_AMOUNT: f32 = 0.04; // How much to expand/contract (more visible)
const IDLE_ANIM_SPEED: f32 = 4.0; // Idle animation speed (frames per second)
